    ...
    computed: {
        isCollapse: {
            ...
            set: function(newValue) {
                this.$store.commit("app/IS_COLLAPSE", newValue);
            },
        },
    },
    methods: {
        ...
        // 用户名下拉菜单选择事件
        logout(command) {
            this.$store.commit("app/TAGES_LIST", []);
            this.$store.commit("app/SET_BREAD", ["home"]);
            this.$store.commit("app/COMMIT_TOKEN", { token: "" });
