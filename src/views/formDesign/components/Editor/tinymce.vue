...
<script>
import { generateUUID, loadJs, loadCss } from "@/utils/index.js";
...
export default {
    ...
    mounted() {
        ...
        tinymce.init({
            ...
            toolbar:
                "insert table | undo redo |  formatselect | bold italic strikethrough forecolor backcolor  | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | code ",
        });
    },
    methods: {
        setHtml(val) {
